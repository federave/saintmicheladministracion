...
<?php require $_SESSION["raiz"] . '/modelo/acuerdos/comodatos/comodatos.php'?>

<div class="contenedorver contenedorvercomodatos">
  <br>
  <br>
          ...
          <div class="row">
           ...
           <div class="row text-center" id="divComodato<?php echo $comodatosId[$k];?>" style="display:none">
             ...
             <br>
              ...
              <div style="border: 1px solid #000000;border-radius: 4px;width:80%;margin:auto" id="divCondicionesComodato<?php echo $comodatosId[$k];?>" class="row text-center"></div>
              <br>
