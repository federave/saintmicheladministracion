...
if(isset($_GET["dato"]))
  ...
  if($conector->abrirConexion())
    ...
    $sql = "SELECT c.id as idcliente ,c.nombre,s.id as idsede,s.nombre,d_s.calle FROM clientes AS c INNER JOIN sedes AS s ON c.id=s.idcliente INNER JOIN direcciones_sedes AS d_s ON s.id=d_s.idsede
