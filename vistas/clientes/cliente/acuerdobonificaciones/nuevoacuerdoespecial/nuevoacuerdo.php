...
<link rel="stylesheet" href="<?php echo $_SESSION["carpeta"] ?>/vistas/clientes/cliente/acuerdobonificaciones/nuevoacuerdoespecial/nuevoacuerdo.css">
<script src="<?php echo $_SESSION["carpeta"] ?>/vistas/clientes/cliente/acuerdobonificaciones/nuevoacuerdoespecial/nuevoacuerdo.js"></script>
...
?>
    ...
    <div class="contenedoracuerdobonificacionesnuevo">
      ...
      <form class="regFormAcuerdoBonificacionesNuevo" id="regFormAcuerdoBonificacionesNuevo" action="../../../controladores/acuerdos/bonificaciones/acuerdobonificacionesespecialnuevo.php">
