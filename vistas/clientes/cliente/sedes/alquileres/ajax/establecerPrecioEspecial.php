...
if(isset($_GET["idsede"])  && isset($_GET["idalquiler"]) && isset($_GET["precio"]))
  {
  $aux=false;
  ...
  if($conector->abrirConexion())
    ...
    if($tabla->num_rows>0)
      ...
      $sql = "INSERT INTO sedes_alquileres_actual (idsede,idalquiler,especial,precioespecial,fechainicio) VALUES ('$idsede','$idalquiler','$especial','$precio','$fechainicio')";
      $aux &= $conexion->query($sql);
