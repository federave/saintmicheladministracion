...
<div class="contenedornuevapromocion">
  ...
  <form id="formularioPromocionNueva" class="formulario"  action="../../../controladores/pedidos/promociones/promocionnueva.php">
      ...
      <div class="funkyradio">
        ...
        while($k<count($productosId))
           ...
           <div class="funkyradio-info text-center">
               <input onchange="mostrarDivProducto(<?php echo $k; ?>)" type="checkbox" name="productosPromocionNueva" id="producto<?php echo $k; ?>PromocionNueva" value="<?php echo $productosId[$k]; ?>"/>
               <label class="labelFormulario" for="producto<?php echo $k; ?>PromocionNueva"><?php echo $productosNombre[$k]; ?></label>
           </div>
           <br>

           <div class="row text-center" id="divProducto<?php echo $k; ?>PromocionNueva" style="display:none;padding:5%;">
             <label class="labelFormulario" for="cantidadProducto<?php echo $k; ?>PromocionNueva">Cantidad</label>
             <input name="cantidadProducto<?php echo $k; ?>PromocionNueva" id="cantidadProducto<?php echo $k; ?>PromocionNueva" type="number" min="0" value="" step="1" placeholder="Cantidad" oninput="this.className = ''" >
             <br>
             <br>
             <label class="labelFormulario" for="bonificadosProducto<?php echo $k; ?>PromocionNueva">Bonificados</label>
             <input name="bonificadosProducto<?php echo $k; ?>PromocionNueva" id="bonificadosProducto<?php echo $k; ?>PromocionNueva" type="number" min="0" value="" step="1" placeholder="Bonificados" oninput="this.className = ''" >
           </div>
  ...
  <div class="" id="alertaPromocionNueva">
